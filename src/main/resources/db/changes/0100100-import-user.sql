...
insert into user.user (id, uuid, username,password,enabled,account_expired,password_change_required,account_locked,account_verified,account_complete,account_refreshed,date_created,last_updated) select id, uuid(), username,password,enabled,account_expired,password_change_required,account_locked,account_verified,account_complete,account_refreshed,date_created,last_updated from core.user;
