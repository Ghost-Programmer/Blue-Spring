...
INSERT INTO `documents`.`menu` (`id`, `name`, `icon`, `lock`,`date_created`,`last_updated`) VALUES ('1', 'sidebar','',1, now(), now());

INSERT INTO `documents`.`menu_item` (`id`,`menu_id`, `sort`,`name`, `icon`,`route`, `url`,`lock`,`date_created`,`last_updated`)
