...
INSERT INTO `documents`.`menu` (`id`, `name`, `icon`, `delete_lock`, `date_created`, `last_updated`)
VALUES ('1', 'sidebar', 'menu', 1, now(), now());

INSERT INTO `documents`.`menu_item` (`id`, `menu_id`, `sort`, `name`, `icon`, `route`, `url`, `delete_lock`,
